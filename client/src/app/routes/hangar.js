...
export default class hangarRoute {
    ...
    constructor() {
        ...
        l.scenograph.actors.player.vehicle.position.z = l.current_scene.objects.platform.mesh.position.z - 2.5; 
        l.scenograph.actors.player.vehicle.position.y = 497.5;

        l.scenograph.actors.player.person.position.x = l.current_scene.objects.platform.mesh.position.x; 
        l.scenograph.actors.player.person.position.z = l.current_scene.objects.platform.mesh.position.z + 10; 
