...
export default class Flight_Instruments {
    ...
    update() {
        ...
        if (l.current_scene.scene_objects.ship && l.current_scene.scene_objects.ship.ready) {
            ...
            const angle = (Math.abs(l.current_scene.scene_objects.ship.state.airSpeed) * 1.94384) * 45;
