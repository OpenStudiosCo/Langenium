...
export default class Flight_Instruments {
    ...
    activate() {
        window.l.ui.flight_instruments.activated = true;
    }
    ...
    update() {
        ...
        if (window.l.current_scene.scene_objects.ship && window.l.current_scene.scene_objects.ship.ready) {
            ...
            if ( window.l.current_scene.settings.game_controls ) {
                if ( !window.l.ui.flight_instruments.activated ) {
                    window.l.ui.flight_instruments.activate();
                }
            }
            ...
            document.querySelector(window.l.ui.flight_instruments.containerSelector + ' #Airspeed #Needle').style.transform = `rotate(${angle}deg)`;
        }
