...
var Simple = function() {
    ...
    this.modelDef = {
        ...
        "name":"jack-back",
        "model":"assets/jack/jack-back.moc",
        "textures":[
            "assets/jack/jack-back.2048/texture_00.png"
        ]
    };
...
Simple.draw = function(gl)
{
    ...
    live2DModel.setParamFloat("PARAM_ARML_WALK", Math.sin(t/cycle));
    live2DModel.setParamFloat("PARAM_ARMR_WALK", -Math.sin(t/cycle));
    live2DModel.setParamFloat("PARAM_LEGL_WALK", -Math.sin(t/cycle));
    live2DModel.setParamFloat("PARAM_LEGR_WALK", Math.sin(t/cycle));
    live2DModel.setParamFloat("PARAM_TORSO_WALK", .5 * Math.sin(t/cycle));
    live2DModel.setParamFloat("PARAM_HEAD_TILT", 2.5 * Math.sin(t/cycle));
