...
{
    // console.log("--> LAppModel.load(gl, " + modelSettingPath + ")");
			...
			for (var i = 0; i < thisRef.modelSetting.getTextureNum(); i++)
			{
				...
				thisRef.loadTexture(i, texPaths, function() {
                    ...
                    if( thisRef.isTexLoaded ) {
                        ...
                        /*
                        for (j = 0; j < thisRef.modelSetting.getInitPartsVisibleNum(); j++)
                        {
...
LAppModel.prototype.update = function()
{
    ...
    this.live2DModel.addToParamFloat(L2DStandardID.PARAM_ANGLE_X, this.dragX * 30, 1); 
    this.live2DModel.addToParamFloat(L2DStandardID.PARAM_ANGLE_Y, this.dragY * 30, 1);
    this.live2DModel.addToParamFloat(L2DStandardID.PARAM_ANGLE_Z, (this.dragX * this.dragY) * -30, 1);

    
    
    this.live2DModel.addToParamFloat(L2DStandardID.PARAM_BODY_ANGLE_X, this.dragX*10, 1); 

    
    
    this.live2DModel.addToParamFloat(L2DStandardID.PARAM_EYE_BALL_X, this.dragX, 1); 
    this.live2DModel.addToParamFloat(L2DStandardID.PARAM_EYE_BALL_Y, this.dragY, 1);


    
    this.live2DModel.addToParamFloat(L2DStandardID.PARAM_ANGLE_X, 
                                     Number((15 * Math.sin(t / 6.5345))), 0.5);
    this.live2DModel.addToParamFloat(L2DStandardID.PARAM_ANGLE_Y, 
                                     Number((8 * Math.sin(t / 3.5345))), 0.5);
    this.live2DModel.addToParamFloat(L2DStandardID.PARAM_ANGLE_Z, 
                                     Number((10 * Math.sin(t / 5.5345))), 0.5);
    this.live2DModel.addToParamFloat(L2DStandardID.PARAM_BODY_ANGLE_X, 
                                     Number((4 * Math.sin(t / 15.5345))), 0.5);
    this.live2DModel.setParamFloat(L2DStandardID.PARAM_BREATH, 
    ...
    {
        this.live2DModel.setParamFloat(L2DStandardID.PARAM_MOUTH_OPEN_Y,
                                       this.lipSyncValue);
    }
...
LAppModel.prototype.feedIn = function()
{
    // console.log("--> LAppModel.feedIn()");
